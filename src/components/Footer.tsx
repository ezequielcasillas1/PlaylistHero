      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 lg:gap-16">
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-sm text-white/50 mb-6 max-w-xs">
              Create perfect YouTube playlists with AI. Music, news, sports, tutorials — describe what you want and enjoy distraction-free viewing.
            </p>
        ...
        <div className="mt-16 pt-8 border-t border-white/5 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <p className="text-sm text-white/40 flex items-center gap-1">
            Made with <Heart className="h-4 w-4 text-red-500 fill-red-500" /> for content lovers
          </p>
        </div>
      </div>
    </footer>
